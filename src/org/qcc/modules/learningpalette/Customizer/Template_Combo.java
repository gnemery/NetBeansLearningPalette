 ...
 * @author Tony
 */
public class Template_Combo extends javax.swing.JPanel {
     ...
     */
    public Template_Combo(String name, String description, ArrayList<CustomizerControl> controls, JTextComponent target) {
    ...
    private void initComponents() {
        ...
        expressionPanel.setToolTipText(org.openide.util.NbBundle.getMessage(Template_Combo.class, "Template_Combo.expressionPanel.toolTipText")); // NOI18N

        comboLabel.setText(org.openide.util.NbBundle.getMessage(Template_Combo.class, "Template_Combo.comboLabel.text")); // NOI18N
        ...
        expressionPanel.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(Template_Combo.class, "Template_Combo.expressionPanel.AccessibleContext.accessibleName")); // NOI18N
    }// </editor-fold>//GEN-END:initComponents


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JComboBox comboDropdown;
    private java.awt.Label comboLabel;
