...
public class LP_Boolean implements IPaletteItemLogic {
    ...
    public String executeLogic(Map<String, String> codeMap, Map<String, String> variableMap) {
        ...
        if (defaultValue.equals("(None)")) {
            ...
            if (defaultValue.equals("True")) {
                codeOutput = codeOutput.replace("$value", codeMap.get("trueValue"));
            } else {
                codeOutput = codeOutput.replace("$value", codeMap.get("falseValue"));
            }
        }
